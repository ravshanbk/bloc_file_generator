import 'package:bloc_file_generator/features/vebinars/data/models/vebinars_model.dart';
    ...
    try {
      ...
      if (response.statusCode != null && response.statusCode! >= 200 && response.statusCode! < 300) {
        return GenericPagination(
            next: null,
            previous: null,
            results: List.generate(10, (index) => VebinarsModel(name: 'name $index', id: index)),
            count: 10);
      } else {
